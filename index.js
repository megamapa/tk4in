	...
	GetSession(req).then(session => {
		...
		switch(session.path) {
			...
			case '/main': {
				...
				res.write("<link rel=stylesheet href='https://api.mapbox.com/mapbox-gl-js/v3.0.0/mapbox-gl.css' crossorigin=anonymous>");
